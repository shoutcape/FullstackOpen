...
const resolvers = {
  ...
  Author: {
    bookCount: (author) => {
      const result = books.filter((book) => book.author === author.name)
  ...
  Mutation: {
    ...
    editAuthor: (root, args) => {
      ...
      const updatedAuthor = { ...target, name: args.name, born: args.setBornTo }
      authors = authors.map((author) => author !== target ? author : updatedAuthor)
